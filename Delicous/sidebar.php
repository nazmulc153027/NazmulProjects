...
*/
 get_header();?>
<img src="<?php echo get_template_directory_uri();?>/assets/img/testimonials-bg.jpg" alt="">
<h1 class="text-center text-white" style="position:absolute; top:350px; left:700px;"><?php wp_title();?></h1>

 <?php
 //only for page pagination
 $temp = $wp_query;
 $wp_query = null;
   ...
   if (have_posts()) {
    ...
    <div class="container-fluid pt-5">
        <div class="row">
            ...
            <div class="col-lg-6 align-items-stretch">
                <h3 class="text-warning text-center"><?php the_title();?></h3>
                <?php the_content();?>
            </div>
        </div>
</div>
